...
- 📫 How to reach me ... <a target="__blank" href="https://www.linkedin.com/in/dcdeepakdc/">`LinkedIn`</a> <a target="__blank" href="https://deepakchouhan.com/">`Website`</a> <a target="__blank" href="https://www.instagram.com/dcdeepakdc/">`Instagram`</a>
...
## 🛠 Tech I use
`Python` `HTML/CSS` `JavaScript` `Node.JS` `Express.JS` `Pandas` `Numpy` `Scikit-Learn` `MongoDB` `Git` `Heroku` `Jenkins` `CI/CD`
 `SonarQube` `Github Actions` `Postman` `Docker` `Kubernetes` `Googling`
